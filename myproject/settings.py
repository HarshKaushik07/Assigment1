...
SECRET_KEY = 'django-insecure-@randomgeneratedkey'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []  # Add your domain or IP if deploying
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydatabase',        # Change to your MySQL database name
        'USER': 'mydatabaseuser',    # Change to your MySQL username
